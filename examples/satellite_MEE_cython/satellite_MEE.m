function [t_arr,x_arr,D_,P_, prop_violated_flag] = satellite_MEE(t,T,XX,D,P,U,I,pc,dense_traces)
D_ = D;
P_ = P;
...
vs1 = veci(1) + omega * reci(2);
vs2 = veci(2) - omega * reci(1);
vs3 = veci(3);
vs = [vs1 vs2 vs3];
...
function y = mu()
y=398603.2;% earth gravitational constant (km**3/sec**2)
end
function y = J2()
y=0.00108263;
end
function y = Re()
y=6378.165;% earth equatorial radius (kilometers)
end
function y = omega()
y= 7.292115486e-5;% earth inertial rotation rate (radians/second)
end
function y = Cd()
y=2.0e-8;% coef. of atmospheric drag
end