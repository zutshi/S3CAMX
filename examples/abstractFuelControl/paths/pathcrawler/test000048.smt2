...
(let ((?x165 (* ?x66 ?x155)))
(let (($x172 (= rv_output_arr__0 ?x165)))
...
(let (($x171 (>= ?x165 (/ 13.0 100.0))))
(let (($x168 (<= ?x165 (/ 83.0 50.0))))
(let (($x164 (>= ?x155 0.0)))
(let (($x157 (<= ?x155 100.0)))
...
(and $x39 $x145 $x45 $x46 $x108 $x110 $x157 $x164 $x168 $x171 $x69 $x159 $x77 $x160 $x80 $x81 $x161 $x172 $x162 $x85)))))))))))))))))))))))))))))))
;(check-sat)
