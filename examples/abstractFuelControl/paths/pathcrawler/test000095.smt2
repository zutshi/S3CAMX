...
(let (($x105 (>= ?x97 (/ 13.0 100.0))))
(let (($x102 (<= ?x97 (/ 83.0 50.0))))
(let (($x114 (>= iv_x_arr__8 70.0)))
(let (($x108 (= iv_float_state_arr__4 0.0)))
(let (($x46 (and (distinct iv_float_state_arr__5 0.0) true)))
(let (($x45 (< ?x43 10.0)))
(let (($x223 (<= iv_x_arr__10 (- 1.0))))
(and $x223 $x45 $x46 $x108 $x114 $x102 $x105 $x69 $x70 $x77 $x79 $x99 $x81 $x82 $x106 $x84 $x100)))))))))))))))))))))))))
;(check-sat)
