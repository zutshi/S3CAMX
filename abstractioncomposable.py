...
#        self.final_cons_list = final_cons_list
        ...
        plant_config = pc.parse_config(config_dict, self.T)
        self.N = plant_config.N
        ...
        if controller_abstraction_type == 'symbolic_pathcrawler':
            ...
            controller_abs = CA.ControllerSymbolicAbstraction(
                    self.num_dims,
                    controller_sym_path_obj,
                    min_smt_sample_dist,
                    smt_solver)
        ...
        if plant_abstraction_type == 'cell':
            ...
            print(plant_abstraction_type)
            raise NotImplementedError
        # Overriding the passed in plant and conctroller abstractions
        plant_abs = PA.PlantAbstraction(plant_config, smt_solver)
        ...
        self.get_reachable_states =\
            self.get_reachable_states_sym if self.controller_abs.is_symbolic\
            else self.get_reachable_states_conc
