...
function ret_cell = simulate_plant_fun(sim_function, t, T, initial_continuous_states, initial_discrete_states, initial_pvt_states, control_inputs, inputs, property_check)
delete 'log_matlab'
diary log_matlab
